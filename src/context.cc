...
bool Context::init()
{
    ...
    m_vertex_buffer = Buffer::create_with_data(GL_ARRAY_BUFFER, GL_STATIC_DRAW, vertex_data, sizeof(float) * 12);

    // set position attribute
    m_vertex_layout->set_attrib(0, 3, GL_FLOAT, GL_FALSE, sizeof(float) * 3, 0);
    // color attribute
